...
if (count($this->urlData)==1){
    ...
    if($id==0){
            ...
            $arr_name=array('ID','Изменено','Изменил','Активный','Основной','Организация','Название','Безналичные','Номер карты','Название банка','БИК банка','Номер счета','Дополнительная информация');
            ...
            $a=DBFetchNew($this->conn, "SELECT 'y', 'Основной' UNION SELECT 'n', 'Не основной'");
