...
if (count($this->urlData)==1){
    ...
    if($id==0){
            ...
            $arr_name=array('ID','Объект', 'Название','Дополнительная информация','Активность','Кто изменил','Когда изменил');
            ...
            $a=DBFetchNew($this->conn, "SELECT id, name FROM ".$pref."clients_object");
