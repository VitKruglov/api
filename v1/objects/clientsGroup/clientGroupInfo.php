...
if (count($this->urlData)==1){
    ...
    if($id==0){
            ...
            $arr_name=array('ID','Название','Ответственный менеджер','Активность','Клиент','Дополнительная информация','Кто изменил','Когда изменил');
            ...
            $a=DBFetchNew($this->conn, "SELECT 0,null UNION SELECT id, name FROM ".$pref."clients");
