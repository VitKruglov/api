...
//-------------------------------------------------------------//
//                                                             //
//        получение информации о счете контрагента по ID     //
//                                                             //
//-------------------------------------------------------------//
...
if (count($this->urlData)==1){
    ...
    if($id==0){
            ...
            $arr_name=array('ID','Активность','Когда изменил','Кто изменил', 'Основной', 'Название','Наличный','Банк-карта','Банк-название', 'Банк-БИК','Банк-счет','Дополнительная информация','Дата начала','Дата окончания');
