...
$result=array();
    ...
    if($result['error']){
        ...
        DBExecuteNew($this->conn, "UPDATE ".$pref."pay_balance SET sum_paid=sum_paid+".$this->postParam['input']['sum']." WHERE id=".$this->postParam['input']['idPayBalance']);
    }
